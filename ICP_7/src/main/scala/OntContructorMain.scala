...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val classes=Source.fromFile("data2/Classes").getLines()
    ...
    val subClasses=Source.fromFile("data2/SubClasses").getLines()
    ...
    val objprop=Source.fromFile("data2/ObjectProperties").getLines()
    objprop.foreach(f=> {
      val farr=f.split(",")
    ...
    val dataprop=Source.fromFile("data2/DataProperties").getLines()
    ...
    val individuals=Source.fromFile("data2/Individuals").getLines()
    ...
    val triplets=Source.fromFile("data2/Triplets").getLines()
    triplets.foreach(f=>{
      val farr=f.split(",")
    ...
    val os = new FileOutputStream("data2/family.owl")
